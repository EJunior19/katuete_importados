...
<div class="flex justify-between items-center mb-4">
    <h3 class="text-xl font-semibold text-gray-700">➕ Nuevo Contacto para {{ $client->name }}</h3>
...
<div class="bg-white rounded shadow p-6">
    ...
    <form action="{{ route('clients.contacts.store', $client) }}" method="POST" autocomplete="off" class="space-y-4">
        @csrf
